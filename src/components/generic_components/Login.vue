          ...
          <div class="right-content">
            ...
            <div class="inpu" >
              ...
              <div class="user-check" :class="{'back':isBack1}">
                <div class="u-check">
                  <input type="text" name="verifyCode" class="check1" placeholder="验证码" @click="changeBack1"    :maxlength="4"  v-model="checkcode">
            ...
            <div class="chk-auto">
              ...
              <div class="check-login">
                <span class="span-agree"><a href="#">免费注册</a></span>
              </div>
            </div>
            <div class="regist-btn">
              <button class="regist-free" type="submit" @click="login">登录</button>
            </div>
          </div>
        </div>
      </div>
...
<script>
  import Identify from  '../generic_components/Identify.vue'
        ...
        if (flag){
          axios.post('http://127.0.0.1:8000/user/login/',{
            ...
            if(response && response.headers.token){
              ...
              //获取之前的网页
              let from=sessionStorage.getItem('from')?sessionStorage.getItem('from'):'/';
              vm.$router.push(from)
            }
            })
